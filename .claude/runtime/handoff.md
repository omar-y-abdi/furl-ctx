...
**REMAINING backlog:** R5 (CCR marker grammar ownership — HIGH, recovery-critical), R6 (ContentRouter god-object split — HIGH), R7 (retention durable spill Sqlite default-off), D3 SmartCrusher MEASURE-not-delete. Then finish: sanity gate+bench → rm codebase-CRITIQUE.md → rerun adversarial-critique.js UNCHANGED → delta report.
**Gate baseline now: suite 571/14, recovery 21, floor held on all 6 datasets, needle 100%. HEAD `64abbbc2`.**
