...
- **WAVE 2 (after Wave 1 gate+commit):** fable-B content_router COR-17/18/30/31/39/47/48 (keep 17+47 as identifiable hunks for bisectability; per-finding bench delta). Then sonnet COR-16/43. Then security cluster COR-21/32/36/37/38/51/54/56 + COR-41.
